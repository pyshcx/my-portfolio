        ...
        >
          {achievements.map((achievement) => {
            ...
            return (
              ...
              >
                <div
                  className="card h-full flex flex-col cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl group"
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden rounded-t-xl mb-4">
                    ...
                    <div className="absolute bottom-3 left-3">
                      <span className="bg-black/60 backdrop-blur-md text-white px-2 py-1 rounded-full text-xs font-medium">
                        {achievement.date}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col px-2">
                    <h3 className="text-xl font-bold text-slate-100 mb-3 group-hover:text-[var(--color-teal)] transition-colors duration-300">
                      {achievement.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-2 mt-auto">
                      {achievement.highlights.slice(0, 3).map((highlight, index) => (
                        <span
                          key={index}
                          className="bg-slate-800 text-slate-300 px-3 py-1 rounded-full text-xs font-medium border border-slate-700 shadow-sm"
                        >
                          {highlight}
                        </span>
                      ))}
                      {achievement.highlights.length > 3 && (
                        <span className="text-[var(--color-teal)] text-xs font-medium px-2 py-1">
                  ...
                  <div className="mt-4 pt-4 border-t border-slate-800">
                    <div className="flex items-center justify-center text-[var(--color-teal)] text-sm font-medium group-hover:text-[var(--color-info)] transition-colors">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 bg-slate-900/90 backdrop-blur-sm text-slate-100 w-10 h-10 rounded-full flex items-center justify-center hover:bg-slate-800 transition-colors text-xl font-light shadow-lg"
                  >
                    ×
                  </button>
                </div>
                ...
                <div className="p-8">
                  <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="badge-ai text-sm font-medium">
                  ...
                  {selectedAchievement.id === 1 ? (
                    <>
                      ...
                      <div className="bg-slate-800 p-6 rounded-xl mb-6">
                        <h4 className="font-semibold text-slate-100 mb-3 text-lg">Project Details:</h4>
                    ...
                    <>
                      ...
                      <div className="bg-slate-800 p-6 rounded-xl mb-6">
                        <h4 className="font-semibold text-slate-100 mb-3 text-lg">Experience Highlights:</h4>
                  ...
                  <div className="border-t border-slate-800 pt-6">
                    <h4 className="font-semibold text-slate-100 mb-4 text-lg">Key Highlights:</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      {selectedAchievement.highlights.map((highlight, index) => (
                        <div
                          key={index}
                          className="bg-slate-800 text-slate-300 px-4 py-3 rounded-lg flex items-center font-medium border border-slate-700"
                        >
                          <div className="w-2 h-2 bg-[var(--color-teal)] rounded-full mr-3 flex-shrink-0"></div>
                          {highlight}
                        </div>
                      ))}
                    </div>
