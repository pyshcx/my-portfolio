...
const articles = [
  {
    ...
    alt: 'GM and Nvidia AI Alliance article cover',
  },
  {
    ...
    alt: 'Ultraviolette Automotive article cover',
  },
  {
    ...
    alt: 'Maserati MC20 autonomous speed record article cover',
  },
  {
    ...
    alt: 'BYD Gods Eye autonomous driving article cover',
  }
];
            ...
            <div className="relative w-full h-[600px] overflow-hidden rounded-xl shadow-lg flex items-center justify-center bg-black">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
                <a
                  ...
                  className="group flex items-center text-white hover:text-[var(--color-teal)] transition-all duration-300"
                >
